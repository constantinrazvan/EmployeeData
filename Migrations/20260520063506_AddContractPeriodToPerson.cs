...
{
    /// <inheritdoc />
    public partial class AddContractPeriodToPerson : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppAccessRoles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppAccessRoles_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppAccessRoles_Persons_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OnboardingTasks_Persons_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppAccessRoles_ApplicationId",
                table: "AppAccessRoles",
                column: "ApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_AppAccessRoles_PersonId",
                table: "AppAccessRoles",
                column: "PersonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OnboardingTasks_PersonId",
